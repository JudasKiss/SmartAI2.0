	...
	<div class="popup_wrap popup_warning">
		...
		<section class="popup_body">
			<div class="popup_container">
				...
				<div class="mg_btn">
					<button class="m_btn btn_blue"id = "btn_delete<c:out value='${report_seq}'/>">OK</button>
...
g_popPage = (function() {
	var report_seq = "<c:out value='${report_seq}'/>";
		...
		function fn_setEvents() {
			...
			/*ok 버튼 클릭*/
		   	$("#btn_delete<c:out value='${report_seq}'/>").on("click",function(){
		   		var params = {};
		   		params["crudMode"]="D";
		   		...
		   		fn_ajax("/ai/project/deleteReport.do", params);
		   	});
