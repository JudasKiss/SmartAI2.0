...
<div class="mg_popup active">
	<div class="popup_wrap popup_createFile">
		...
		<button class="btn_popup_close" id="btn_close2">
			팝업 닫기
		</button>
	</div>
</div>
...
g_popPage = (function() {
    ...
    function fn_setEvents() {
		...
		$("#btn_finish").on("click",function(){
	   		...
	   		params["pid"] = "${pid}";
	   		params["wname"] = $(".m_select").selectpicker('val');
	   		if($(".option_box.option_copy").hasClass("active")){
		   		...
		   		fn_ajax("/ai/project/insertWorkflow.do", params);
	   		}
		});
   ...
   function fn_projectList() {
 	  ...
 	  $(".option_box.option_copy .m_select").selectpicker('destroy');
 	     ...
 	     fn_ajax("/ai/project/projectWfList.do", params);
   }
