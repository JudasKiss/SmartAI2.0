			...
			<div class="popup_container">
				...
				<ul class="mg_form">
					<li>
						...
						<div class="ans">
							<input type="text" class="m_text<c:out value='${report_seq}'/>" placeholder="Enter the File Name">
						</div>
					</li>
					<li>
						<div class="que">Description</div>
						<div class="ans lineBreak">
							<textarea class="m_textarea<c:out value='${report_seq}'/>" placeholder="Enter the Description.(Option)"></textarea>
				...
				<div class="mg_btn">
					<button class="m_btn btn_blue" id="btn_save<c:out value='${report_seq}'/>">Save</button>
...
g_popPage = (function() {
    ...
    function fn_setEvents() {    
    	...
    	$("#btn_save<c:out value='${report_seq}'/>").on("click",function(){
	   		var params = {};
	   		params["crudMode"]="U";
	   		params['title'] = $(".m_text<c:out value='${report_seq}'/>").val();
	   		params['description'] = $(".m_textarea<c:out value='${report_seq}'/>").val();
	   		...
	   		fn_ajax("/ai/project/reviseReport.do", params);
	   	});
    	...
    	$("#btn_cancel").on("click",function(){
	   	...
	   	/* 글자수 카운팅 */
		$(".m_textarea<c:out value='${report_seq}'/>").keyup(function() {
   ...
   function fn_nameChkSuccess(data) {
 	   if(data.result && data.result != "0") {
 	        ...
 	        var opts = {};
 	        opts["focusName"] = ".m_text<c:out value='${report_seq}'/>";
   ...
   function fn_selectReportSuccess(result) {  
	   // 컨트롤러 result에 담긴 값은 입력된 api정보
	      ...
	      $(".m_text<c:out value='${report_seq}'/>").val(ReportInfos.title);
	      $(".m_textarea<c:out value='${report_seq}'/>").val(ReportInfos.description);
